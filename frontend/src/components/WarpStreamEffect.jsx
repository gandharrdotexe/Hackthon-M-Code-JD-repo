...
const WarpStreamEffect = ({ className = "", useVideo = true }) => {
  ...
  if (useVideo) {
    return (
      <div className={`absolute inset-0 overflow-hidden ${className}`}>
        ...
        <video
          ref={videoRef}
          src="/videos/futuristic-background4.mp4"
          autoPlay
          loop
          muted
          playsInline
        ...
        />
        {/* Maja nahi aara tha */}
        {/* Soft opacity overlay to make video less heavy */}
        <div className="absolute inset-0 bg-black/30" />

        {/* Optional gradient overlay to maintain depth and readability */}
...
export default WarpStreamEffect;
